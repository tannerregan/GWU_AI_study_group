...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \begin{itemize}
            ...
            \item Also had trouble reading from outside of it's current working directory
            \item Claude wrote up \href{\ghLtwo/stata_vscode_demo/mcp_stata_fix.md}{instructions}  to fix both
        \end{itemize}
        \item Work (mostly) as normal
        \begin{itemize}
            \item Some things different, e.g. 'browse' (needs point and click), 'desc' and 'count' (sometimes don't run from script)
        \end{itemize}
    ...
    \begin{itemize}
        ...
        \item Each project gets its own \textbf{environment}: a fixed set of packages and versions
            \begin{itemize}
                ...
                \item[$\circ$] Ensures others can reproduce your results exactly (store in \texttt{.yml} file)
            \end{itemize}
