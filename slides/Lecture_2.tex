...
\begin{itemize}
    \item Quick recap of Session 1
        \begin{itemize}
            \item[$\circ$] Tools overview, Claude Code interfaces, Git concepts, VS Code setup
        \end{itemize}
    \vspace{.05in}
    \item Today: hands-on workflows
        \begin{enumerate}
            ...
            \item Data analysis demo with Claude Code (Ask / Plan mode)
            \item Project structure, CLAUDE.md, and replication packages
            \item Working with Git and coauthors in VS Code
            \item Python in VS Code: environments and Jupyter
            \item Stata with Claude Code
        \end{enumerate}
    \item Lots of time for questions and live demos
\end{itemize}
