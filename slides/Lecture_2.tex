...
\begin{itemize}
    ...
    \begin{itemize}
        \item Use the Stata Workbench Extension
        ...
        \end{itemize}
    \item Otherwise, Claude Code can work with Stata similarly to python
    \end{itemize}
    \textcolor{gray}{\textit{$\triangleright$ Stata \& VS Code Demo slide}}
\end{itemize}
