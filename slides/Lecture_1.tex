...
\begin{itemize}
    ...
    \end{itemize}
    \vfill\footnotesize
    Read more \href{https://claesbackman.com/claude-code-guide.html\#:~:text=CUSTOMISATION,md\%20and\%20Skills}{here} (full descriptions, examples of CLAUDE.md and skills, download pre-made skills)
...
\begin{center}
    \includegraphics[width=\textwidth, height=0.82\textheight, keepaspectratio]{../figures/screenshots/calude_md_example.png}
\end{center}
