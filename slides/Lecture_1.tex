...
\begin{itemize}
    ...
    \item Core features:
        \begin{itemize}
            ...
            \item[$\circ$] \textbf{Extensions}: Git, Jupyter, Claude Code, and more
            \item[$\circ$] \textbf{Command Palette} (\hlcode{Ctrl+Shift+P}): search and run any action by name
        \end{itemize}
    \vspace{.05in}
    \item Resources: \href{https://code.visualstudio.com/docs/introvideos/basics}{Official intro videos (Microsoft)}, \href{https://code.visualstudio.com/docs/getstarted/tips-and-tricks}{Tips and Tricks (Microsoft)}
\end{itemize}
...
%%%%%%%%%%%%%%
\begin{frame}
\frametitle{VS Code with Claude Overview}

\begin{itemize}
    \item Key panels: Explorer (files), Editor, Terminal, Source Control (Git), Extensions, Claude Code
    \item CC Modes:
        \begin{itemize}
...
Extensions
Reading and rendering files
Claude extension: Current file selection
